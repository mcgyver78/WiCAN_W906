...
---
> **WiCAN_W906 fork:** Mercedes-Benz Sprinter W906 (EU) support for the WiCAN OBD – CAN wake-up, 35 engine values via MQTT, idle mode, reading/clearing trouble codes of 18 control units and a Node-RED dashboard. Documentation: [English](W906.en.md) | [Deutsch](W906.md). Firmware: [Releases](https://github.com/mcgyver78/WiCAN_W906/releases).
